        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-8">
            {cities.map((city) => (
              ...
              >
                <div className="mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-primary-50 text-primary-500 transition-colors group-hover:bg-primary-100">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-primary-50 text-primary-500 transition-colors group-hover:bg-primary-100">
